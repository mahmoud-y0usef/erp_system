...
<div class="session">
    ...
    <form action="function/login.php" method="post" class="log-in" autocomplete="off">
        <?php
        if (isset($_GET['error'])) {
        ...
        <div class="floating-label">
            <input placeholder="أدخل البريد الإلكتروني" type="email" name="email" required id="email"
                autocomplete="off">
        ...
        <div class="floating-label">
            <input class="password" placeholder="أدخل الرمز السري" type="password" name="password" required id="password"
                autocomplete="off">
            <label for="password">Password:</label>
        <div class="icon">

        <i class="pass fa-regular fa-eye-slash"></i>
